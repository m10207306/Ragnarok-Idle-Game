...
map_data = \
    [    # en_name,      zh_name,                             type   BGM                              可前往的地圖編號       在地圖總覽中的座標位置
        ...
        [27, "morroc",       "沙漠之都　夢羅克",                1,     "morroc",                        [28, 31, 33, 38, 39], pygame.Rect(center2_x,             center2_y,             map_size, map_size)],
        [28, "moc_fild01",   "夢羅克　區域1",                  2,     "moc_fild_01_07",                [9, 10, 27, 29, 44],  pygame.Rect(center_x,              center_y + 2 * step,   map_size, map_size)],
        [29, "moc_fild02",   "夢羅克　區域2",                  2,     "moc_fild_02_03_13",             [28, 34, 44],         pygame.Rect(center2_x - 2 + 4 * step,  center2_y - 1 * step,  map_size, map_size)],
        [30, "moc_fild03",   "夢羅克　區域3",                  2,     "moc_fild_02_03_13",             [34, 41],             pygame.Rect(center2_x - 2 + 5 * step,  center2_y,             map_size, map_size)],
        ...
        [34, "moc_fild13",   "夢羅克　區域13",                 2,     "moc_fild_02_03_13",             [29, 30],             pygame.Rect(center2_x - 2 + 4 * step,  center2_y,             map_size, map_size)],
        ...
        [40, "payon",        "山岳之都　斐揚",                 1,     "payon",                          [41, 47, 50],        pygame.Rect(center2_x - 2 + 6 * step,  center2_y - 1 * step,  map_size, map_size)],
        [41, "pay_fild01",   "斐揚　區域1",                    2,     "pay_fild_01_02_03_04_08",       [30, 40, 42, 46],     pygame.Rect(center2_x - 2 + 6 * step,  center2_y,             map_size, map_size)],
        [42, "pay_fild02",   "斐揚　區域2",                    2,     "pay_fild_01_02_03_04_08",       [41, 43],             pygame.Rect(center2_x - 2 + 6 * step,  center2_y + 1 * step,  map_size, map_size)],
        [43, "pay_fild03",   "斐揚　區域3",                    2,     "pay_fild_01_02_03_04_08",       [42, 45, 46, 51],     pygame.Rect(center2_x - 2 + 7 * step,  center2_y + 1 * step,  map_size, map_size)],
        [44, "pay_fild04",   "斐揚　區域4",                    2,     "pay_fild_01_02_03_04_08",       [28, 29],             pygame.Rect(center_x + 1 * step,   center_y + 2 * step,   map_size, map_size)],
        [45, "pay_fild06",   "斐揚　區域6",                    2,     "pay_fild_06_07_09_10",          [43],                 pygame.Rect(center2_x - 2 + 7 * step,  center2_y + 2 * step,  map_size, map_size)],
        [46, "pay_fild07",   "斐揚　區域7",                    2,     "pay_fild_06_07_09_10",          [41, 43, 47, 49],     pygame.Rect(center2_x - 2 + 7 * step,  center2_y,             map_size, map_size)],
        [47, "pay_fild08",   "斐揚　區域8",                    2,     "pay_fild_01_02_03_04_08",       [40, 46, 48],         pygame.Rect(center2_x - 2 + 7 * step,  center2_y - 1 * step,  map_size, map_size)],
        [48, "pay_fild09",   "斐揚　區域9",                    2,     "pay_fild_06_07_09_10",          [47, 49],             pygame.Rect(center2_x - 2 + 8 * step,  center2_y - 1 * step,  map_size, map_size)],
        [49, "pay_fild10",   "斐揚　區域10",                   2,     "pay_fild_06_07_09_10",          [46, 48],             pygame.Rect(center2_x - 2 + 8 * step,  center2_y,             map_size, map_size)],
        [50, "payon",        "斐揚洞穴口",                     1,     "payon",                         [40],                 pygame.Rect(center2_x - 2 + 6 * step,  center2_y - 2 * step,  map_size, map_size)],
        [51, "alberta",      "港口之都　艾爾貝塔",              1,     "alberta",                       [43],                 pygame.Rect(center2_x - 2 + 8 * step,  center2_y + 1 * step,  map_size, map_size)],
