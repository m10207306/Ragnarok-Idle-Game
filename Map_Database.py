...
map_data = \
    [    # en_name,      zh_name,                             type   BGM                              可前往的地圖編號       在地圖總覽中的座標位置
        ...
        [32, "moc_fild11",   "夢羅克　區域11",                 2,     "moc_fild_11_12_17_18_19",       [32, 36],            pygame.Rect(center2_x + 1 * step,  center2_y + 1 * step,  map_size, map_size)],
        ...
        [42, "pay_fild02",   "斐揚　區域2",                    2,     "pay_fild_01_02_03_04_08",       [41, 43, 44],        pygame.Rect(center2_x + 6 * step,  center2_y + 1 * step,  map_size, map_size)],
        ...
        [44, "pay_fild04",   "斐揚　區域4",                    2,     "pay_fild_01_02_03_04_08",       [42, 45],            pygame.Rect(center2_x + 6 * step,  center2_y + 2 * step,  map_size, map_size)],
        [45, "pay_fild06",   "斐揚　區域6",                    2,     "pay_fild_06_07_09_10",          [43, 44],            pygame.Rect(center2_x + 7 * step,  center2_y + 2 * step,  map_size, map_size)],
        ...
        [50, "pay_arche",    "斐揚洞穴口",                    2,     "payon",                          [40],                pygame.Rect(center2_x + 6 * step,  center2_y - 2 * step,  map_size, map_size)],
        ...
        [61, "mjolnir_10",   "妙勒尼　山脈10",                 2,     "mjolnir_05_10_11_12",           [2, 52, 59, 62],     pygame.Rect(center_x,              center_y - 2 * step,   map_size, map_size)],
