...
class CharacterClass:
    def __init__(self, name, ini_ability):
        ...
        self.item.add_item(Item.ItemObj(1, (0, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (0, 3), self, 1))
        self.item.add_item(Item.ItemObj(1, (0, 5), self, 1))
        self.item.add_item(Item.ItemObj(1, (1, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (2, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (4, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (5, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (6, 0), self, 1))
        self.item.add_item(Item.ItemObj(1, (6, 1), self, 1))
        self.item.add_item(Item.ItemObj(1, (6, 2), self, 1))
        self.item.add_item(Item.ItemObj(1, (6, 3), self, 1))
